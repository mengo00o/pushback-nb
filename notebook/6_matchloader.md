# Match Loader (tongue mech)
### What is it?

A match loader or tongue mech is an extending arm located at the front of the robot or where the intake is. The arm is powered by pneumatics and can be put up as well as down. It goes inside the match load zone dispenser or under the balls and helps you intake the balls. Once the match loader is inside the ball dispenser, all the balls should be fed into your intake. It can also serve the purpose of aligning your bot during scoring on the tallest goal.  
  
*p.s. The tall dispenser where the balls are dispensed is called a match loader, as well as the mechanism to intake the balls from the dispenser.*
...
- Stand-offs also bent inwards and were incredibly flimsy after extensive use
- L channels were at different angles on each side, which made the pneumatic bend the match loader terribly
- Match loader had a small margin of success and needed too much time to align/ the perfect angle
- It wasn't long enough and constantly hit the roller

**Pros**
- Consistently works the same
- was within the sizing limits
- Triangle braces that helped it stabilize
